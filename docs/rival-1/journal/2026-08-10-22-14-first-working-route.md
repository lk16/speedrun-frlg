...
**Done.** 11873 frames, Squirtle, tier-1 verified (`docs/rival-1/route.md`, `route/rival-1/ledger.json`). Segment
code in `crates/frlg-route`, logs in `route/rival-1/logs`, checkpoints in `$FRLG_ARTIFACTS/states/route`
